...
def prepare_release(
    *,
    ...
    pull_request = repository.create_pull(
        title=title, base=base, head=f"{owner}:{branch}", body=release.body
    )
...
@click.option(
    "--remove", metavar="REMOTE", default="origin", help="remote for GitHub repository"
)
@click.option(
    "--base",
    metavar="BRANCH",
...
def main(
    ...
    """Open a pull reuqest to release this project.
